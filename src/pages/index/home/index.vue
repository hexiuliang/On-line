  ...
  export default {
    ...
    data() {
      return {
        ...
        mokuailist:[
          {img:'/static/images/cs.png',val:'财商教育',id:'1'},
          {img:'/static/images/wh.png',val:'文化教育',id:'2'},
          {img:'/static/images/qkl.png',val:'区块链教育',id:'3'},
          {img:'/static/images/qb.png',val:'全部',id:'0'},
        ],
        hotarr:[
